...
/* Bind user profile links */
container.querySelectorAll('.pdb-user-link').forEach(a=>{a.onclick=e=>{e.preventDefault();openMyProfile(a.dataset.user)}});
/* Bind role filter */
