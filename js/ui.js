...
else if(entry&&entry.start&&entry.end&&!_todayShiftEnded)availHtml='<span class="dim">|</span><span style="color:#ffcc44;font-weight:600">'+t('avail.today')+' ('+fmtTime12(entry.start)+' - '+fmtTime12(entry.end)+')</span>';
