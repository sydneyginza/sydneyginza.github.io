...
const formFields=['fName','fAge','fBody','fHeight','fCup','fVal1','fVal2','fVal3','fSpecial','fExp','fStartDate','fLang','fOldUrl','fType','fDesc'];
let formLabels=[];
