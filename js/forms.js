...
const formFields=['fName','fAge','fBody','fHeight','fCup','fVal1','fVal2','fVal3','fSpecial','fExp','fStartDate','fLang','fType','fEmail','fMobile','fDesc'];
let formLabels=[];
