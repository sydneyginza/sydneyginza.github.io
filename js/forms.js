...
else{document.getElementById('formTitle').textContent=t('form.addGirl');formFields.forEach(id=>document.getElementById(id).value='');document.getElementById('fStartDate').value=fmtDate(getAEDTDate());formPhotos=[];formLabels=[];formLabelsJa=[];formCountries=[]}renderFormPhotos();renderFormLabels();renderFormLabelsJa();renderFormCountries();formOverlay.classList.add('open')}
